    ...
    import {addMessageBodyActionCreator, updateNewMessageBodyActionCreator} from "../../redux/state";
    ...
    return (
        <div className={s.dialogs}>
            ...
            <div>
                <textarea onChange={onMessageChange} ref={newTextElement} rows={10} cols={30}></textarea>
